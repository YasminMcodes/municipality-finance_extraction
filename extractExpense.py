...
def fetch_all_expense_data(slug: str, year: int):
    if year <= 2015:
...
for _, row in df.iterrows():
    ...
    expense_data = fetch_all_expense_data(slug, year)
...
with open("expense_data.csv", "w", newline='', encoding='utf-8') as f:
...
print("✅ Saved to expense_data.csv")
